...
export default function HondaCity (){
    return(
        <div className="flex flex-col justify-center items-center space-y-16 my-4">
            <div className="">
                <h1 className="font-serif text-4xl text-gray-700 font-bold">Honda City 2024 Price In Pakistan , Images , Reviews & Specs</h1>
            </div>
            ...
            <div className="text-2xl text-green-500 font-serif">PKR 50,00,000</div>
            <div>
